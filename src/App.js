		...
		return ( 	
			<Provider store = {store}>
				<div>
					...
					/* см. след. строку (продолжение) defaultOpenId={articles[0].id} - первыя статья по умолчанию открыта (но без анимации (style.css что бы не забыть)) accordeon.js style.css index.js (быв. Article) */
